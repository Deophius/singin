...
def get_plan(sess, taskid):
    ...
    The time string has the following format: 2022-05-15 14:00:00
    This time string can be directly handed off to the database.
    '''
    try:
        url = config['url_plan']
        ua = config['user_agent']
    ...
    s = reply['result'][0]['StartTime']
    e = reply['result'][0]['EndTime']
